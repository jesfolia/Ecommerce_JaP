...
document.addEventListener("DOMContentLoaded", function (e) {
    document.getElementById("Guardar").onclick = function (e) {
         userdata = { pNombre: document.getElementById('pNombre').value, sNombre: document.getElementById('sNombre').value, pApellido: document.getElementById('pApellido').value, sApellido: document.getElementById('sApellido').value, Email: document.getElementById('Email').value, Telefono: document.getElementById('Telefono').value}
        localStorage.setItem('userdata', JSON.stringify(userdata));
    };
    let userdatag = JSON.parse(localStorage.getItem('userdata'));
...
imagen.addEventListener("load", function () {
    ...
    let imgAsDataURL = imgCanvas.toDataURL("https://ibb.co/HG0D2GB");
